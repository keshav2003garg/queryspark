    ...
    return (
        <View className='flex-1'>
            ...
            <View className='flex-1 justify-center items-center'>
                <Text className='text-[#989898] font-[Poppins-Medium] text-4xl absolute bottom-[130px]'>
                    No Chats, yet
                </Text>
                <Text className='text-[#636363] text-lg text-center leading-5 absolute bottom-[80px]'>
